...
function GameOver() {
    Estrellarse();
    gameOver.style.display = "block";
    document.addEventListener("keydown", ReiniciarDespuesDeGameOver);
}

function ReiniciarJuego() {
    // Restablece todas las variables y elementos del juego a su estado inicial aquí.
    sueloX = 0;
    velEscenario = 1280/3;
    gameVel = 1;
    score = 0;
    ...
    suelo.style.animationDuration = "2s";
...
function ReiniciarDespuesDeGameOver(event) {
    if (event.keyCode === 32) {
        ReiniciarJuego();
        document.removeEventListener("keydown", ReiniciarDespuesDeGameOver);
    }
}
</script>
</body>
